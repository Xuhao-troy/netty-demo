...
//            KeyManagerFactory keyMgrFact = KeyManagerFactory.getInstance("PKIX", BouncyCastleJsseProvider.PROVIDER_NAME);
            KeyManagerFactory keyMgrFact = KeyManagerFactory.getInstance("X.509", BouncyCastleJsseProvider.PROVIDER_NAME);
...
//            TrustManagerFactory trustMgrFact = TrustManagerFactory.getInstance("PKIX", BouncyCastleJsseProvider.PROVIDER_NAME);
            TrustManagerFactory trustMgrFact = TrustManagerFactory.getInstance("X.509", BouncyCastleJsseProvider.PROVIDER_NAME);
